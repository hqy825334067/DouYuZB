...
extension PageContentView : UICollectionViewDelegate {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if currentOffsetX > startOffsetX { // 左滑
            // 1.计算progress
            progress = currentOffsetX.truncatingRemainder(dividingBy: scollViewW)
            ...
            // 4.如果完全划过去
            if currentOffsetX - startOffsetX == scollViewW {
                progress = 1
            ...
            // 1.计算progress
            progress = 1 - currentOffsetX.truncatingRemainder(dividingBy: scollViewW)
